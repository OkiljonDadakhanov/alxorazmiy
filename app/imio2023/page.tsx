...
export default function AlKhwarizmiOlympiad() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      if (goldCount < 7) setGoldCount((prev) => prev + 1);
      if (silverCount < 14) setSilverCount((prev) => prev + 1);
      if (bronzeCount < 20) setBronzeCount((prev) => prev + 1);
    }, 100);
  ...
  const excursionHighlights: ExcursionHighlight[] = [
    { icon: FaLandmark, text: "The State Museum of History of Uzbekistan" },
    { icon: FaMapMarkedAlt, text: "Amir Timur Square" },
    { icon: FaStore, text: "The Chorsu Bazaar" },
    { icon: FaTree, text: "Tashkent City Park" },
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 leading-relaxed mb-3">
        The 1st International Al-Khwarazmi Young Mathematicians Olympiad took
        place from May 29 to June 4, 2023, uniting 70 talented participants from
        various countries. This prestigious event, dedicated to the legendary
        mathematician Muhammad ibn Musa Al-Khwarazmi, aimed to foster a love for
        mathematics and provide a platform for young minds to showcase their
        problem-solving skills.
      </p>
      <p className="text-gray-700 leading-relaxed mb-3">
        The Olympiad provided a platform for young mathematicians to showcase
        their problem-solving skills and compete at an international level.
        Participants tackled challenging mathematical problems, demonstrating
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          Beyond the competition, participants had the opportunity to explore
          the cultural and historical landmarks of Tashkent, the capital of
          Uzbekistan. A special excursion was organized, allowing students to
          visit museums, national parks, and famous historical sites.
        </p>
  ...
  return (
    ...
    >
      ...
      <p className="mb-4 leading-relaxed">
        The 1st International Al-Khwarazmi Olympiad was more than just a
        competition—it was a celebration of mathematical excellence and cultural
        exchange. Participants not only tested their skills but also built
        connections with fellow young mathematicians from different countries.
      </p>
      <p className="font-semibold text-lg">
        We look forward to welcoming even more participants in the next edition
        of the Al-Khwarazmi Olympiad, continuing to inspire the next generation
        of mathematicians!
      </p>
    </motion.section>
  );
