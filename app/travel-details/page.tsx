        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">
              Watch this video guide about the visa process for traveling to Uzbekistan
            </p>
          </div>
          <div className="w-full max-w-3xl mx-auto rounded-2xl overflow-hidden shadow-xl border border-slate-100">
            <iframe
